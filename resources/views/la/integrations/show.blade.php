...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $integration->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Integrations", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/integrations/'.$integration->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Integrations", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.integrations.destroy', $integration->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/integrations') }}" data-toggle="tooltip" data-placement="right" title="Back to Integrations"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'integration_url')
						@la_display($module, 'supplier')
						@la_display($module, 'crontab')
						@la_display($module, 'start_date')
						@la_display($module, 'end_date')
						@la_display($module, 'stock_verge')
					</div>
				</div>
			</div>
		</div>
