...
<div id="headerwrap">
    <div class="container">
        <div class="row centered">
            ...
            <div class="col-lg-2">
                <h5>Integrator nasıl çalışır</h5>
                <p>Modern Arayüz</p>
                <img class="hidden-xs hidden-sm hidden-md" src="{{ asset('/la-assets/img/arrow1.png') }}">
            </div>
            <div class="col-lg-8">
               <center> <img class="img-responsive" src="http://www.karesoft.com.tr/wp-content/uploads/2015/10/karesoft_logo_arka.png" alt=""></center>
            </div>
            <div class="col-lg-2">
                <br>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7">
				...
				<h3 class="feature-title">Integrator</h3><br>
                <ol class="features">
					<li>Lorem implesum</li>
				</ol>
            </div>
        </div>
    </div><!--/ .container -->
...
<div id="footerwrap">
    <div class="container">
        <div class="col-lg-5">
			...
			<div class="contact-link"><i class="fa fa-envelope-o"></i> <a href="mailto:agit@karesoft.com.tr">agit@karesoft.com.tr</a></div>
			<div class="contact-link"><i class="fa fa-building"></i> <a href="http://karesoft.com.tr">karesoft.com.tr</a></div>
        </div>
...
<div id="c">
    <div class="container">
        <p>
            <strong>Copyright &copy; 2018. Powered by <a href="http://www.karesoft.com.tr"><b>Karesoft</b></a>
        </p>
    </div>
</div>
