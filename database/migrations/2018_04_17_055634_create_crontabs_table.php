...
class CreateCrontabsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Crontabs", 'crontabs', 'name', 'fa-cube', [
            ["name", "Cron Adı", "Name", false, "", 0, 256, false],
            ["cron_time", "Cron Aralığı", "Name", false, "", 0, 256, false],
        ]);
    ...
    {
        if (Schema::hasTable('crontabs')) {
            Schema::drop('crontabs');
        }
    }
}
